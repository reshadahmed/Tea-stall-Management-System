...
import java.time.format.*;
    ...
    public class carrot extends JFrame implements ActionListener
    {
        ...
        carrot() 
        {
			...
			txtarea = new JTextArea("Name: Carrot"+"\nScientific name:Daucus carota"+"\nSoil:Moist well drained soil"+"\nFertilizer : 15-5-10 fertilizer"+"\n             Organic vegetable fertilizer "+"\nHervest :60-80 days after planting"+"\nSeason: Rabi ");
