...
import java.time.format.*;
    ...
    public class khafi extends JFrame implements ActionListener
    {
        ...
        khafi() 
        {
            ...
            imgLabel.setBounds(297, 10, logo.getIconWidth(), logo.getIconHeight());
            c.add(imgLabel);
			
			lbl = new JLabel("KHAFI");
			lbl.setBounds(210,80,350,50);
			lbl.setFont(f2);
			c.add(lbl);
