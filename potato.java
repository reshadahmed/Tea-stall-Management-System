...
import java.time.format.*;
    ...
    public class potato extends JFrame implements ActionListener
    {
        ...
        potato() 
        {
			...
			txtarea = new JTextArea("Name: Potato"+"\nScientific name:Solanum tuberosum"+"\nSoil:Sandy, well-drained soil"+"\nFertilizer : 15-15-15 fertilizer (when planting)"+"\n             34-0-0 fertilizer (1 or 2 months after planting)			"+"\nHervest :80-130 days after planting"+"\nSeason: Rabi ");
