...
import java.time.format.*;
    ...
    public class report extends JFrame implements ActionListener
    {
        ...
        report() 
        {
			...
			txtarea = new JTextArea("Your N-P-K ratio is below 4-2-1. To fertilize "+"your field soil to a standard state you have to "+"add the following fertilizers to "+"your field."+"\n1. Urea "+"\n2. Ammonium Sulphate "+"\n3. Potassium Sulphate "+"\n\n ");
